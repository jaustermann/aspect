...
namespace aspect
{
  namespace InitialConditions
  {
    ...
    template <int dim>
    void
    SAVANIPerturbation_TXlith<dim>::initialize()
    {
    ...
    template <int dim>
    void
    SAVANIPerturbation_TXlith<dim>::declare_parameters (ParameterHandler &prm)
    {
      prm.enter_subsection("Initial conditions");
      {
        prm.enter_subsection("SAVANI perturbation TX lithosphere");
        {
    ...
    template <int dim>
    void
    SAVANIPerturbation_TXlith<dim>::parse_parameters (ParameterHandler &prm)
    {
      AssertThrow (dim == 3,
...
namespace aspect
{
  namespace InitialConditions
  {
    ASPECT_REGISTER_INITIAL_CONDITIONS(SAVANIPerturbation_TXlith,
                                       "SAVANI perturbation TX lithosphere",
