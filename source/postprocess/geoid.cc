                  ...
                  for (unsigned int iord = 0; iord < ideg+1; iord++)
                    {
                      ...
                      // conversion from geoid to gravity anomaly is given by gravity_anomaly = (l-1)*g/R_surf * geoid_anomaly
    ...
    prm.enter_subsection("Postprocess");
    {
      prm.enter_subsection("Geoid");
      {
        ...
        prm.declare_entry("Also output the gravity anomaly", "false",
                          Patterns::Bool(),
                          "Option to also output the free-air gravity anomaly up to the maximum degree in mgal. "
